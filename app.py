...
def test():
        ...
        parser.add_argument('--latent_file1',default="latent_W/realsample_" + "0" + n1 +".npy")
        parser.add_argument('--latent_file2',default="latent_W/realsample_" + "0" + n2 +".npy")
        parser.add_argument('--latent_file_mean1',default="latent_W/realsample_01.npy")
        parser.add_argument('--latent_file_mean2',default="latent_W/realsample_02.npy")
        parser.add_argument('--latent_file_mean3',default="latent_W/realsample_03.npy")
        ...
        save_image(synth_img.clamp(0,1),"templates/new_contents_test_real_19.png")
