...
def main():
    ...
    #parser.add_argument('--latent_file4',default="latent_W/sample.npy")
    #parser.add_argument('--latent_file5',default="latent_W/sample.npy")
    ...
    latents =  i*latents_0+j*latents_1+k*latents_2#+l*latents_3+m*latents_4
