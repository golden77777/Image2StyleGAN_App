...
def main():
     ...
     parser.add_argument('--src_dir',default="../drive/MyDrive/20201127_images/")
     parser.add_argument('--weight_file',default="../drive/My Drive/stylegan_pretrained_model/pytorch/karras2019stylegan-ffhq-1024x1024.pt",type=str)
